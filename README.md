...
Current scope note: an `MTK-85`/single-board `8085` trainer was considered as a possible parallel development track and explicitly rejected. This repo stays focused on the Rodney-native `Vector 8801-6` wire-wrap path rather than a separate trainer-board line.
